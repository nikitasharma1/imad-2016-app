...
var articles = {   
    'about': {
        ...
        content:  {
            info: [
                {
                    title: '<img class="slide img-responsive thumbnail" src="/ui/Slide1.JPG" alt="ACADEMICS">',
                    arr: [1, 2, 3]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="/ui/Slide2.JPG" alt="WEB DEVELOPMENT SKILLS">',
                    arr: [4, 5, 6]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="/ui/Slide3.JPG" alt="PROJECTS">',
                    arr: [7, 8, 9]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="/ui/Slide4.JPG" alt="CERTIFICATIONS">',
                    arr: [10, 11, 12]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="/ui/Slide5.JPG" alt="OTHER SKILLS">',
                    arr: [13, 14, 16]
                }
            ]
        }
...
function createTemplate(data){
    ...
    var getContent = function getcontent(content1) {
        ...
        if(typeof(content1) === 'object'){
            ...
            {
                out += '<div class="container"><ul id="info">';
                for(var i in content1.info) {
                out += '<li class="text-center col-md-6" id="slide-container">'+content1.info[i].title+'</li>';
                }
                out += '</ul></div>';
            }
        } 
