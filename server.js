            ...
            info: [
                {
                	...
                	<div id="myCarousel" class="carousel slide thumbnail" data-ride="carousel">
                        ...
                        <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
                          <span class="glyphicon glyphicon-menu-left btn-sm" aria-hidden="true"></span>
                          <span class="sr-only">Previous</span>
                        </a>
                        <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
                          <span class="glyphicon glyphicon-menu-right btn-sm" aria-hidden="true"></span>
                ...
                },
                {
                	...
                	<div id="myCarousel" class="carousel slide thumbnail" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                          <div class="item active">
                            <img src="http://placehold.it/400x250" alt="Chania" width="460" height="345">
                          </div>
                          ...
                          <div class="item">
                            <img src="http://placehold.it/400x250" alt="Flower" width="460" height="345">
                          </div>
