...
var articles = {   
    'about': {
        ...
        content:  {
            info: [
                {
                    title: '<img class="slide img-responsive thumbnail col-sm-2" src="/ui/Slide1.JPG" alt="ACADEMICS">',
                    arr: [1, 2, 3]
                },
                {
                    title: '<img class="slide img-responsive thumbnail col-sm-2" src="/ui/Slide2.JPG" alt="WEB DEVELOPMENT SKILLS">',
                    arr: [4, 5, 6]
                },
                {
                    title: '<img class="slide img-responsive thumbnail col-sm-2" src="/ui/Slide3.JPG" alt="PROJECTS">',
                    arr: [7, 8, 9]
                },
                {
                    title: '<img class="slide img-responsive thumbnail col-sm-2" src="/ui/Slide4.JPG" alt="CERTIFICATIONS">',
                    arr: [10, 11, 12]
                },
                {
                    title: '<img class="slide img-responsive thumbnail col-sm-2" src="/ui/Slide5.JPG" alt="OTHER SKILLS">',
                    arr: [13, 14, 16]
                }
            ]
        }
