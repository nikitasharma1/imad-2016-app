            ...
            info: [
                {
                    ...
                    <div class="w3-content w3-display-container" style="max-width:800px">
                      <img class="slide img-responsive thumbnail mySlides" src="img_nature_wide.jpg" style="width:100%">
                      <img class="slide img-responsive thumbnail mySlides" src="img_fjords_wide.jpg" style="width:100%">
                      <img class="slide img-responsive thumbnail mySlides" src="img_mountains_wide.jpg" style="width:100%">
                      <div class="slide img-responsive thumbnail" w3-center w3-section w3-large w3-text-white w3-display-bottommiddle" style="width:100%">
