...
var articles = {   
    'about': {
        ...
        content:  {
            info: [
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x300" alt="ACADEMICS">',
                    arr: [1, 2, 3]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x300" alt="WEB DEVELOPMENT SKILLS">',
                    arr: [4, 5, 6]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x250" alt="PROJECTS">',
                    arr: [7, 8, 9]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x250" alt="CERTIFICATIONS">',
                    arr: [10, 11, 12]
                },
                {
