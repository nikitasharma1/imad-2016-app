...
var articles = {   
    'about': {
        ...
        content:  {
            info: [
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="ACADEMICS">',
                    arr: [1, 2, 3]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="WEB DEVELOPMENT SKILLS">',
                    arr: [4, 5, 6]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="PROJECTS">',
                    arr: [7, 8, 9]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="CERTIFICATIONS">',
                    arr: [10, 11, 12]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="OTHER SKILLS">',
                    arr: [13, 14, 16]
                },
                {
                    title: '<img class="slide img-responsive thumbnail" src="http://placehold.it/500x350" alt="OTHER SKILLS">'
...
function createTemplate(data){
    ...
    var getContent = function getcontent(content1) {
        ...
        if(typeof(content1) === 'object'){
            ...
            {
                out += '<div class="container-fluid"><ul id="info">';
