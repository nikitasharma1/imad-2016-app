                      ...
                      <div class="container-fluid container" id="main-nav-inner-div">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                          ...
                          <ul class="nav navbar-nav navbar-right text-center">
                            ...
                            <li><a href="/nikitasharma/about" class="color-white"> ABOUT ME </a></li>
                            <li><a href="/nikitasharma/portfolio" class="color-white"> PORTFOLIO </a></li>
                            <li><a href="/nikitasharma/contact" class="color-white"> CONTACT ME </a></li>
                          </ul>
                        </div>
                      </div>
                    </nav>
...
app.get('/nikitasharma/:articleName', function (req, res) {
